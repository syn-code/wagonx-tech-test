...
<code>OPEN_WEATHER_API=https://api.openweathermap.org/data/2.5/forecast </br>
OPEN_WEATHER_API_KEY=open-weather-api-key</br>
OPEN_WEATHER_GEO_API=https://api.openweathermap.org/geo/1.0/direct</code>
